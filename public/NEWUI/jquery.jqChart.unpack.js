...
(function () {
    ...
    function ya(a, c, b) {
        var d, e;
        if (Ib(c)) if (M(b)) a.setAttribute(c, b);
        else {
            if (a && a.getAttribute) e = a.getAttribute(c)
        } else if (M(c) && Jb(c)) for (d in c) a.setAttribute(d, c[d]);
        return e
    }
    function mc(a) {
    ...
    function Hd(a, c) {
        function b(m, h) {
            ...
            function Ya() {
                ...
                t([pb, Wb, dc], function (A) {
                    for (var ea in A) if (A[ea].isActive) A[ea].isActive = false;
                    else {
                        A[ea].destroy();
                        delete A[ea]
                    }
            ...
            var s = this,
                ...
                Zd = h.labels.formatter ||
            function () {
                var l = this.value;
                return Ic ? Kc(Ic, l) : Va % 1E6 === 0 ? l / 1E6 + "M" : Va % 1E3 === 0 ? l / 1E3 + "k" : !gb && l >= 1E3 ? Gd(l, 0) : l
            }, Lc = L && h.labels.staggerLines, Xb = h.reversed, Yb = gb && h.tickmarkPlacement == "between" ? 0.5 : 0;
            x.prototype = {
                addLabel: function () {
                    var l = this.pos,
                        p = h.labels,
                ...
                render: function (l, p) {
                    var r = !this.minor,
                        ...
                        ea = r ? h.gridLineColor : h.minorGridLineColor,
            ...
            return {
                ...
                refresh: function (G) {
                    ...
                    if (I) {
                        I = mc(I);
                        D = I.length;
                        for (var Ab; D--;) if (I[D] && (Ab = G.series[D ? "yAxis" : "xAxis"])) {
                ...
                var aa = function (s) {
                        if (!(s && s.touches && s.touches.length > 1)) {
                            ...
                            var J = s.chartX,
                                Q = s.chartY,
                                G = !hc(J - U, Q - Z);
                            if (Gb && s.type == "touchstart") if (ya(s.target, "isTracker")) m.runTrackerClick || s.preventDefault();
        ...
        function g(m) {
            var h = m.type || u.type || u.defaultSeriesType,
                x = sb[h],
                w = q.hasRendered;
            if (w) if (Ga && h == "column") x = sb.bar;
        ...
        function n(m, h) {
            ...
            t([
                ...
                if (x && x.text && !O) q[w] = Y.text(x.text, 0, 0).attr({
                    ...
                    "class": "highcharts-" + w,
                    zIndex: 1
                }).css(x.style).add().align(x, false, tc)
            })
        }
        function z() {
            ib = u.renderTo;
            ...
            Ga, Y, id, Nd, jd, nd, rc, qd, rd, pd, kd, Sd, ae = function (m) {
                ...
                function O(v) {
                    ...
                    if (!hb) {
                        ...
                        v.legendItem = hb = Y.text(I.labelFormatter.call(v), 0, 0).css(v.visible ? ha : L).on("mouseover", function () {
                            v.setState(xb);
                            hb.css(Ka)
                        ...
                        if (!H && v.options && v.options.lineWidth) {
                            ...
                            v.legendLine = Y.path([Wa, -Ea - ta, 0, Aa, -ta, 0]).attr(P).add(ra)
                        }
        ...
        rc = function () {
            ...
            if (m.enabled && !m.floating) if (O == "right") M(Na) || (zb = Ca(zb, Sb - x + h + jb));
    ...
    var Da = document,
        ...
        Tc = rb.SVGAngle || Da.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
    ...
    if (!eb && rb.jQuery) {
        ...
        kb.fx.step._default = function (a) {
            var c = a.elem;
            c.attr ? c.attr(a.prop, a.now) : de.apply(this, arguments)
        };
    ...
    Xc = {
        init: function (a, c, b) {
            ...
            var i, j, k = function (n) {
                    for (g = n.length; g--;) n[g] == Wa && n.splice(g + 1, 0, n[g + 1], n[g + 2], n[g + 1], n[g + 2])
                };
            if (e) {
                k(c);
                k(b)
    ...
    Fc.prototype = {
        ...
        attr: function (a, c) {
            ...
            if (Ib(a)) {
                ...
                if (be && b == "stroke-width" && d === 0) d = 1.0E-6;
        ...
        destroy: function () {
            ...
            yc(this.renderer.alignedObjects, this);
    ...
    Sc.prototype = {
        ...
        buildText: function (a, c) {
            for (var b = c.toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br[^>]?>/g), d = a.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = ya(a, "x"), i, j = d.length; j--;) a.removeChild(d[j]);
            t(b, function (k, n) {
                var z, K = 0,
                    ja;
                ...
                t(z, function ($) {
                    if ($ !== "" || z.length == 1) {
                        ...
                        e.test($) && ya(u, "style", $.match(e)[1].replace(/(;| |^)color([ :])/, "$1fill$2"));
                        if (f.test($)) {
    ...
    if (!Tc) {
        var fe = wb(Fc, {
            ...
            attr: function (a, c) {
                ...
                if (Ib(a)) {
                    ...
                    if (k && /^(x|y|r|start|end|width|height|innerR)/.test(b)) {
                        ...
                        this.dashstyle = d;
                        n = true
                    } else if (b == "fill") if (i == "SPAN") g.color = d;
                    else {
            ...
            shadow: function (a) {
                ...
                if (a) {
                    for (a = 1; a <= 3; a++) {
                        g = ['<shape isShadow="true" strokeweight="', 7 - 2 * a, '" filled="false" path="', i, '" coordsize="100,100" style="', b.style.cssText, '" />'];
        ...
        Ja.prototype = va(Sc.prototype, {
                ...
                return oa(e, {
                    ...
                    getCSS: function (f) {
                        var g = this.top,
                            ...
                            k = g + this.height;
                        g = {
                            clip: "rect(" + T(f ? i : g) + "px," + T(f ? k : j) + "px," + T(f ? j : k) + "px," + T(f ? g : i) + "px)"
                        };
                        !f && wc && oa(g, {
                            width: j + bb,
                            height: k + bb
            ...
            color: function (a, c, b) {
                ...
                if (a && a.linearGradient) {
                    ...
                    b = ["<", b, ' colors="0% ', j, ",100% ", n, '" angle="', a, '" opacity="', z, '" o:opacity2="', k, '" type="gradient" focus="100%" />'];
            ...
            symbols: {
                ...
                rect: function (a, c, b, d) {
                    ...
                    var f = a + e,
                        g = c + d;
                    b = ab(b, e, d);
                    return [Wa, a + b, c, Aa, f - b, c, "wa", f - 2 * b, c, f, c + 2 * b, f - b, c, f, c + b, Aa, f, g - b, "wa", f - 2 * b, g - 2 * b, f, g, f, g - b, f - b, g, Aa, a + b, g, "wa", a, g - 2 * b, a + 2 * b, g, a + b, g, a, g - b, Aa, a, c + b, "wa", a, c, a + 2 * b, c + 2 * b, a, c + b, a + b, c, "x", "e"]
                }
            }
        })
    }
    ...
    lb.prototype = {
        ...
        setTooltipPoints: function (a) {
            ...
            t(d, function (j, k) {
                ...
                for (g = j.high = d[k + 1] ? Mb((j.plotX + (d[k + 1] ? d[k + 1].plotX : e)) / 2) : e; f <= g;) i[b ? e - f++ : f++] = j
            });
        ...
        drawGraph: function () {
            ...
            t(a.segments, function (u) {
                ...
                if (ja) {
                    ...
                    Na == 3 && N.push(Aa, n[1], n[2]);
                    if (c.stacking && a.type != "areaspline") for (ka = u.length - 1; ka >= 0; ka--) N.push(u[ka].plotX, u[ka].yBottom);
    ...
    var Yc = wb(lb, {
        ...
        translate: function () {
            ...
            var z = j.pointWidth,
                ...
                ja = y(z, n - 2 * K),
                $ = K + (e + ((d ? b - a.columnIndex : a.columnIndex) || 0) * n - c / 2) * (d ? -1 : 1),
    ...
    Ja = wb(lb, {
        ...
        translate: function () {
            ...
            t(K, function (ca) {
                ...
                z = (n + k) / 2;
                ca.slicedTranslation = jc([ub(z) * d + g.plotLeft, yb(z) * d + g.plotTop], T);
                N = ub(z) * f[2] / 2;
                ka = yb(z) * f[2] / 2;
                ...
                for (u = 0; u < 2; u++) {
                    ...
                    for (na = 0; na < K[ca].length; na++) {
                        ...
                        if (g = c.dataLabel) {
                            ...
                            if (j) if (u && c.rank < a) ga = tb;
                            else if (!ka && $ < n + k || ka && $ > n - k) {
                                $ = n + N * k;
                                ja = this.getX($, ca > 1);
                                if (!ka && $ + k > z || ka && $ - k < z) if (u) ga = tb;
                                else a++
                            }
...
(function () {
    ...
    p(y.prototype, {
        getSVG: function (b) {
            ...
            s(c.series, function (l) {
                ...
                s(l.data, function (g) {
                    k = g.config;
                    f = p(typeof k == "object" && k.constructor != Array && g.config, {
                        x: g.x,
                        y: g.y,
                        name: g.name
                    });
        ...
        contextMenu: function (b, c, a, e, d, k) {
            ...
            if (!m) {
                ...
                f.exportMenuHeight = m.offsetHeight
            }
            b = {
                display: "block"
            };
        ...
        addButton: function (b) {
            ...
            if (d.enabled !== false) {
                l = e.rect(0, 0, h, i, d.borderRadius, b).align(d, true).attr(p({
    ...
    y.prototype.callbacks.push(function (b) {
        var c, a = b.options.exporting,
            e = a.buttons;
        if (a.enabled !== false) for (c in e) b.addButton(e[c])
    })
})();