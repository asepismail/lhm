...
var $ez=array('fontSize'=>6); // used for storing most of the page configuration parameters
...
function Cezpdf($paper='FOLIO',$orientation='landscape'){
	...
	$this->ez['topMargin']=20;
	$this->ez['bottomMargin']=20;
	$this->ez['leftMargin']=30;
	$this->ez['rightMargin']=15;
...
function Cezpdf2($paper,$orientation){
	// Assuming that people don't want to specify the paper size using the absolute coordinates
	// allow a couple of options:
	// orientation can be 'portrait' or 'landscape'
	// or, to actually set the coordinates, then pass an array in as the first parameter.
