...
class pms_m_daftpengajuan extends Model{
	...
	function read_ppj($company, $dept)
    {
		...
		$sql2 = "SELECT ppjd.PROJECT_PROP_ID, PROJECT_PROP_AFD,PROJECT_PROP_TYPE, ppj.PROJECT_PROPNUM_NUMID,PROJECT_PROPNUM_DATE,PROJECT_PROPNUM_PELAKSANA,";
		...
		$sql2 .= " PROJECT_PROP_UOM, PROJECT_PROP_VALUE,PROJECT_PROP_TVALUE, ppj.COMPANY_CODE, ISDETAIL, ppj.ISAPPR_ADM, ppj.ISAPPR_LVL1,";
		$sql2 .= " ppj.ISAPPR_LVL0, ppj.ISAPPR_LVL2, ppj.ISREVISED,ppj.ISCLOSED,ppj.PROP_STATUS FROM pms_project_propnum ppj";
