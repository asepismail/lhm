...
$.fn.themeswitcher = function(settings){
	...
	var button_default = {
		...
		fontSize: '11px',
		color: '#666',
		background: '#eee url(/themeroller/themeswitchertool/images/buttonbg.png) 50% 50% repeat-x',
	...
	.find('.jquery-ui-themeswitcher-icon').css({
		...
		width: '16px',
		height: '16px',
		background: 'url(/themeroller/themeswitchertool/images/icon_color_arrow.gif) 50% 50% no-repeat'
	});	
	//pane css
	switcherpane.css({
		position: 'absolute',
	...
	.find('li').hover(
		function(){ 
			$(this).css({
				'borderColor':'#555',
				'background': 'url(/themeroller/themeswitchertool/images/menuhoverbg.png) 50% 50% repeat-x',
				cursor: 'pointer'
			}); 
		},
		function(){ 
