...
colModelT_sMonitoringRM.push({name:'ISAPPR1',index:'ISAPPR1', editable: false, edittype:'checkbox', editoptions: { value:"1:0"}, formatter: "checkbox", formatoptions: {disabled : true}, hidden:false, width: 60, align:'center'});
...
colModelT_sMonitoringRM.push({name:'ISAPPR2',index:'ISAPPR2', editable: false, edittype:'checkbox', editoptions: { value:"1:0"}, formatter: "checkbox", formatoptions: {disabled : true}, hidden:false, width: 60, align:'center'});
