...
$(function() {
     $("#form_input").dialog({
		...
		buttons: {
					'Tutup': function() {
						if( $("#i_ino_pengajuan").val() == "" || $("#i_pjsementara").val() == "" || $("#i_afd").val() == "" || $("#i_typepj").val() == "" || $("#i_subtypepj").val() == "" || $("#i_lokasi").val() == "" || $("#i_aktivitas").val() == "" || $("#i_start").val() == "" || $("#i_end").val() == "" || $("#i_qty").val() == "" || $("#i_satuan").val() == "" ){
						} else {
							var inisial = 'simpan';
...
<table width="608" border="1">
 ...
 <tr>
  ...
  <tr>
    <td>AFD</td>
    <td>:</td> 
    <td><? if(isset($afd)){ echo $afd; } ?> &nbsp; <span style="font-size:9px; color:#F00">* </span></td>
  </tr>
  <tr>
    <td>Type Project</td>
    <td>:</td> 
  ...
  <tr> 
    <td>Tgl Mulai</td>
    <td>:</td>
    <td><input tabindex="13" type="text" style="width:100px;" id="i_start" class="input"/>
    &nbsp; <span style="font-size:9px; color:#F00">* </span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Qty</td>
    <td>:</td>
    <td><input tabindex="15" type="text" style="width:100px;" id="i_qty" class="input"/>
    &nbsp; <span style="font-size:9px; color:#F00">* </span></td>
  </tr>
  <tr>
    <td>Satuan</td>
    <td>:</td>
    <td><? if(isset($satuan)){ echo $satuan; } ?>&nbsp; <span style="font-size:9px; color:#F00">* </span></td>
  </tr>
  <tr>
    <td>Rupiah Per Satuan</td>
    <td>:</td>
    <td><input tabindex="17" type="text" style="width:120px;" id="i_rpsat" class="input"/>
    </td>
  </tr>
  <tr>
    <td>Rupiah Total</td>
    <td>:</td>
    <td><input tabindex="18" type="text" style="width:120px;" id="i_rptotal" class="input"/>
    </td>
  </tr>
  <tr>
    <td>Catatan</td>
