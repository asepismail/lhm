<br/>
<form id="gen_x" action="<?= base_url().'index.php/rpt_progress_n/generate' ?>" method="post">
...
<option value='lc'>Project Land Preparation</option>
<option value='tanam'>Project Tanam</option>
<option value='pj_bibitan'>Project Bibitan</option>
<option value='umum'>Umum</option>
<option value='tehnik'>Teknik</option>
<option value='pall'>Preview All</option>
</select>
</td></tr>
