$(function() {
	...
	$(".acc .head").click(function() {	
		var i;
		for (i = 0; i < 10; ++i) {
			var dname = 'div.menu_body' + i	
			$(this).css({color:"#2B6893"}).next(dname).slideToggle(300).siblings(dname).slideUp("slow");
		}
	...
	$('.dd0').click(function () {
		$('ul.menu_body0').slideToggle(100);
	});
	$('.dd1').click(function () {
		$('ul.menu_body1').slideToggle(100);
	});
	$('.dd2').click(function () {
		$('ul.menu_body2').slideToggle(100);
	});
	$('.dd3').click(function () {
		$('ul.menu_body3').slideToggle(100);
	});
	$('.dd4').click(function () {
		$('ul.menu_body4').slideToggle(100);
	});
	$('.dd5').click(function () {
		$('ul.menu_body5').slideToggle(100);
	});
	$('.dd6').click(function () {
		$('ul.menu_body6').slideToggle(100);
	});
	$('.dd7').click(function () {
		$('ul.menu_body7').slideToggle(100);
	});
	$('.dd8').click(function () {
		$('ul.menu_body8').slideToggle(100);
	});
	$('.acts').click(function () {
