...
var url = "<?= base_url().'index.php/' ?>";
		jQuery("#submitdata").click(function (){
			...
			window.location = url+'rpt_tandaterima/generate/'+ periode + '/' + gc;
...
<div class="teks_headline"><strong><?php echo $company_dest;?><br>Generate Excell Report<br/></strong></div><hr style="border: none 0;border-top: 1px dashed #000;width: 100%;height: 1px; padding-bottom:4px;"/>
...
<tr><td>Kode Kemandoran</td><td>:</td><td style="font-size: 11px;"><?php echo $GANG_CODE; ?></td></tr>
